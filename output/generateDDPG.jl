...
@time Episode_DDPG_MF_Agent_Pendulum = @distributed (vcat) for i=1:10
    agent(Pendulum(), AgentParameter(training_episodes=500, train_start=2))
end

@save "./output/Pendulum/Episode_DDPG_MF_Agent_Pendulum.bson" Episode_DDPG_MF_Agent_Pendulum 
